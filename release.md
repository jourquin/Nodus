...
- Nodus 8.5 (first build on XXXX) reintroduces lines & services, which were disabled since Nodus 8.0, with a completely redesigned workflow based on Virtual Network Version 4.
