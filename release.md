...
- Nodus 8.6 (first build on October 1, 2026) is a performance-focused release, highlighting faster assignments, more responsive map navigation and faster database operations. 
