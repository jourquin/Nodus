/**
 * Copyright 2015-2017 Knowm Inc. (http://knowm.org) and contributors. Copyright 2011-2015 Xeiam LLC
 * (http://xeiam.com) and contributors. Licensed under the Apache License, Version 2.0 (the
...
@Override
  public void doPaint(Graphics2D g) {
    ...
    for (PieSeries series : map.values()) {
      ...
      if (pieStyler.hasAnnotations()) {
        ...
        // BAJ : control annotation style
        if (series.getAnnotationsStyle() == AnnotationsStyle.never) {
          annotationWillFit = false;
        } else {
          if (series.getAnnotationsStyle() == AnnotationsStyle.always) {
            annotationWillFit = true;
          }
        }
        // BAJ : end
  ...
  private Shape getDonutSliceShape(
    ...
    Shape inner =
        new Arc2D.Double(
            pieBounds.getX() + pieBounds.getWidth() * thickness,
            pieBounds.getY() + pieBounds.getHeight() * thickness,
            pieBounds.getWidth() - 2 * pieBounds.getWidth() * thickness,
            pieBounds.getHeight() - 2 * pieBounds.getHeight() * thickness,
            start + extent,
            -extent,
            Arc2D.OPEN);
