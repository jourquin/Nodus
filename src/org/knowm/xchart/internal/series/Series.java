...
public abstract class Series {
  ...
  private AnnotationsStyle annotationsStyle = AnnotationsStyle.ifFits;

  public void setAnnotationsStyle(AnnotationsStyle annotationStyle) {
    this.annotationsStyle = annotationStyle;
  }

  public AnnotationsStyle getAnnotationsStyle() {
    return annotationsStyle;
  }
  // BAJ : end
