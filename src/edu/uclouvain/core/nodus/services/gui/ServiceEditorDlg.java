...
import edu.uclouvain.core.nodus.services.Service;
...
public class ServiceEditorDlg extends EscapeDialog {
   ...
   */
  public ServiceEditorDlg(ServiceEditor serviceEditor) {
    super(
        serviceEditor.getNodusMapPanel().getMainFrame(),
        i18n.get(ServiceEditorDlg.class, "Service_editor", "Service editor"),
        false);
  ...
  private void fillInTableService(String nameService) {
    ...
    Service s = serviceEditor.getService(nameService);
    if (s != null) {
      modeltable.addRow(
          new Object[] {
  ...
  private JButton getCancelButton() {
    if (cancelButton == null) {
      ...
      cancelButton.setText(i18n.get(ServiceEditorDlg.class, "Cancel", "Cancel"));
      cancelButton.addActionListener(
          new java.awt.event.ActionListener() {
            @Override
            public void actionPerformed(java.awt.event.ActionEvent e) {

              Service s = serviceEditor.getCurrentService();
  ...
  private JButton getCloseButton() {
    if (closeButton == null) {
      ...
      closeButton.setText(i18n.get(ServiceEditorDlg.class, "Close", "Close"));
  ...
  private JButton getCopyButton() {
    if (copyButton == null) {
      ...
      copyButton.setText(i18n.get(ServiceEditorDlg.class, "Copy", "Copy"));
          ...
          new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
              ...
              if (keyCopy != null) {
                ...
                Service s = serviceEditor.getService(key);

                serviceEditor.displayService(keyCopy);
                Service serviceCopy = serviceEditor.getCurrentService();
  ...
  private JButton getDeleteButton() {
    if (deleteButton == null) {
      ...
      deleteButton.setText(i18n.get(ServiceEditorDlg.class, "Delete", "Delete"));
  ...
  private JButton getEditButton() {
    if (editButton == null) {
      ...
      editButton.setText(i18n.get(ServiceEditorDlg.class, "Edit", "Edit"));
  ...
  private JPanel getEditPanel() {
    if (editPanel == null) {
      ...
      editPanel.add(
          new JLabel(i18n.get(ServiceEditorDlg.class, "Service_Name", "Name")),
          setContraints(
              0,
              0,
              1,
      ...
      editPanel.add(
          new JLabel(i18n.get(ServiceEditorDlg.class, "Service_Index", "Index")),
          setContraints(
              2,
              0,
              1,
      ...
      editPanel.add(
          new JLabel(i18n.get(ServiceEditorDlg.class, "Service_Mode", "Mode")),
          setContraints(
              0,
              1,
              1,
      ...
      editPanel.add(
          new JLabel(i18n.get(ServiceEditorDlg.class, "Service_Means", "Means")),
          setContraints(
              2,
              1,
              1,
      ...
      editPanel.add(
          new JLabel(i18n.get(ServiceEditorDlg.class, "Service_Frequency", "Frequency")),
          setContraints(
              0,
              2,
              1,
      ...
      editPanel.add(
          new JLabel(i18n.get(ServiceEditorDlg.class, "Service_Description", "Description")),
          setContraints(
              0,
              3,
              1,
      ...
      period[0] = i18n.get(ServiceEditorDlg.class, "year", "year111");
      period[1] = i18n.get(ServiceEditorDlg.class, "month", "month");
      period[2] = i18n.get(ServiceEditorDlg.class, "week", "week");
      period[3] = i18n.get(ServiceEditorDlg.class, "day", "day");
  ...
  private JButton getNewButton() {
    if (newButton == null) {
      ...
      newButton.setText(i18n.get(ServiceEditorDlg.class, "New", "New"));
  ...
  private JButton getSaveButton() {
    if (saveButton == null) {
      ...
      saveButton.setText(i18n.get(ServiceEditorDlg.class, "Save", "Save"));
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
              ...
              if (JDBCUtils.getInt(frequencyField.getText()) == Integer.MIN_VALUE) {
                ...
                JOptionPane.showMessageDialog(
                    ...
                    MessageFormat.format(
                        i18n.get(ServiceEditorDlg.class, "not_correct", "{0} not correct."),
                        i18n.get(ServiceEditorDlg.class, "frequency_value", "frequency value")),
                    NodusC.APPNAME,
                    JOptionPane.ERROR_MESSAGE);
                return;
              }
              ...
              if (name.compareTo("") != 0) {
                ...
                JOptionPane.showMessageDialog(
                    ...
                    MessageFormat.format(
                        i18n.get(ServiceEditorDlg.class, "not_correct", "{0} not correct."),
                        i18n.get(ServiceEditorDlg.class, "name_value", "name value")),
                    NodusC.APPNAME,
                    JOptionPane.ERROR_MESSAGE);
              }
            }
  ...
  private JTable getServiceTable() {
    ...
    if (serviceTable == null) {
      modeltable.addColumn(i18n.get(ServiceEditorDlg.class, "Service_Index", "Index"));
      modeltable.addColumn(i18n.get(ServiceEditorDlg.class, "Service_Name", "Name"));
      modeltable.addColumn(i18n.get(ServiceEditorDlg.class, "Service_Mode", "Mode"));
      modeltable.addColumn(i18n.get(ServiceEditorDlg.class, "Service_Means", "Means"));
      modeltable.addColumn(i18n.get(ServiceEditorDlg.class, "Service_Frequency", "Freqyency"));
      modeltable.addColumn(i18n.get(ServiceEditorDlg.class, "Service_Type", "Type"));
