...
public class NodusC {
  ...
  /** Version of the virtual-network methodology generated by Nodus. */
  public static final int VIRTUAL_NETWORK_MODEL_VERSION = 4;

  /** Current persisted virtual-network result-table format. */
  public static final int VIRTUAL_NETWORK_TABLE_FORMAT_VERSION = 4;
  ...
  /** Name of the virtual-link type field in assignment virtual-network tables. */
  public static final String DBF_VIRTUAL_LINK_TYPE = "vtype";
